...
- (void)setMenuView
{
    ...
    CGFloat x = self.view.width*0.5 - W*1.5;
    ...
    for(CLImageToolInfo *info in self.toolInfo.sortedSubtools){
        ...
        if ([info.toolName isEqualToString:@"CLDrawTool"] ||
            [info.toolName isEqualToString:@"CLTextTool"] ||
            [info.toolName isEqualToString:@"CLClippingTool"])
        {
...
- (void)tappedMenuView:(UITapGestureRecognizer*)sender
{
    ...
    if ([view.toolInfo.toolName isEqualToString:@"CLClippingTool"]) {
...
#pragma mark - PhotoTweaksViewcontroller delegate
