...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    [self.drawImageView1.image drawInRect:CGRectMake(0, 0, self.drawImageView1.frame.size.width, self.drawImageView1.frame.size.height)];
...
- (UIImage *)image {
    return [self.drawImageView1 image];
}
